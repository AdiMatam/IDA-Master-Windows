...
#include <sunlinsol/sunlinsol_dense.h> /* access to SuperLUMT linear solver    */
#include <sunmatrix/sunmatrix_dense.h> /* access to sparse SUNMatrix           */
