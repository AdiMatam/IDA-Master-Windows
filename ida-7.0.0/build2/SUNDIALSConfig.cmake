...
if("ON" AND NOT TARGET MPI::MPI_C)
  set(MPI_C_COMPILER "C:/msys64/mingw64/bin/mpicc.exe")
  find_dependency(MPI)
endif()
...
if("ON" AND NOT TARGET SUNDIALS::KLU)
  if("")
    ...
    target_link_libraries(SUNDIALS::KLU INTERFACE "C:/Coding/Research/IDA-Temp/suitesparse/lib/libklu.dll.a;C:/Coding/Research/IDA-Temp/suitesparse/lib/libamd.dll.a;C:/Coding/Research/IDA-Temp/suitesparse/lib/libcolamd.dll.a;C:/Coding/Research/IDA-Temp/suitesparse/lib/libbtf.dll.a;C:/Coding/Research/IDA-Temp/suitesparse/lib/libsuitesparseconfig.dll.a")
    set_target_properties(SUNDIALS::KLU PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "C:/Coding/Research/IDA-Temp/suitesparse/include/suitesparse")
  endif()
endif()
...
if("ON" AND NOT TARGET SUNDIALS::SUPERLUMT)
  ...
  target_link_libraries(SUNDIALS::SUPERLUMT INTERFACE "C:/coding/research/ida-temp/superlu/lib/libsuperlu_mt_PTHREAD.a")
  set_target_properties(SUNDIALS::SUPERLUMT PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "C:/Coding/Research/IDA-Temp/superlu/SRC")
endif()
